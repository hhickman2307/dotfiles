...
changeprofile()
{
    ...
    case "$1" in
        ...
        STEEL)
          ...
          local NC="\e[0m" #White
          export PS1="\[$Gray\033(0\154\033(B\][\[\033(0\161\161\033(B$Gray\][\[$Red\]\u\[$Gray\]]\[\033(0\161\033(B\][\[$Red\]\w\[$Gray\]]\[\033(0\161\033(B\][\[$Red\]$(parse_git_branch) \[$Gray\]]\[\033(0\161\161\033(B\]]\n\[$Gray\033(0\155\161\033(B$Gray\][\[$Red\]\#\[$Gray\]]\[\033(0\161\033(B\][\[$Red\]\$\[$Gray\]]\[\033(0\161\161\033(B\][\[$NC\]" 
          export PROFILE='STEEL'
          ;;
        RAVEN)
          local DkGrn="\e[38;5;22m"
          local NC="\e[0m"
          export PS1="\[$DkGrn\033(0\154\033(B\][\[\033(0\161\161\033(B$DkGrn\][\[$NC\]\u\[$DkGrn\]]\[\033(0\161\033(B\][\[$NC\]\w\[$DkGrn\]]\[\033(0\161\033(B\][\[$NC\]$(parse_git_branch) \[$DkGrn\]]\[\033(0\161\161\033(B\]]\n\[$DkGrn\033(0\155\161\033(B$DkGrn\][\[$NC\]\#\[$DkGrn\]]\[\033(0\161\033(B\][\[$NC\]\$\[$DkGrn\]]\[\033(0\161\161\033(B\][\[$NC\]" 
